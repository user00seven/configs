...
beautiful.notification_shape_border_width = 3
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn("alacritty -e tmux") end,
...
awful.spawn.with_shell("feh -r --bg-fill --randomize /usr/share/wallpapers/")
