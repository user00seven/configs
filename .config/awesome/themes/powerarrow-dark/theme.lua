...
theme.font                                      = "DaddyTimeMono Nerd 8"
theme.fg_normal                                 = theme_color.font_color or "#DDDDFF" 
...
theme.awesome_icon_launcher                     = theme.dir .. "/icons/menu.svg"
